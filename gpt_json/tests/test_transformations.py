...
@pytest.mark.parametrize(
    ...
    [
        ('{ "key1": "value1", "key2": "value2", ', { "key1": "value1", "key2": "value2"}, JsonFixEnum.UNCLOSED_OBJECT),
        ('[{"key1": "value1"}, {"key2": "value2"}, ', [{"key1": "value1"}, {"key2": "value2"}], JsonFixEnum.UNCLOSED_OBJECT),
        ('{ "key1": "value1", "key2": { "nestedKey": "nestedValue",', { "key1": "value1", "key2": { "nestedKey": "nestedValue"}}, JsonFixEnum.UNCLOSED_OBJECT),
        ('[{"key1": "value1"}, {"key2": "value2"}, {"key3": "value3", "key4": "value4",', [{"key1": "value1"}, {"key2": "value2"}, {"key3": "value3", "key4": "value4"}], JsonFixEnum.UNCLOSED_OBJECT),
        ('[{"key1": "value1"}, {"key2": [1, 2, 3,', [{"key1": "value1"}, {"key2": [1, 2, 3]}], JsonFixEnum.UNCLOSED_OBJECT),
        ('{ "key1": "value1", "key2": "value2"}', { "key1": "value1", "key2": "value2"}, None),
        ('[{"key1": "value1"}, {"key2": "value2"}]', [{"key1": "value1"}, {"key2": "value2"}], None),
        # test case with an escaped quote
        ('[{"key1": "value1"}, {"key2": "value2 \\" and a quote', [{"key1": "value1"}, {"key2": "value2 \" and a quote"}], JsonFixEnum.UNCLOSED_VALUE),
        ('[{"key1": "value1"}, {"key2": "value2 start\n\n', [{"key1": "value1"}, {"key2": "value2 start"}], JsonFixEnum.UNCLOSED_VALUE),
        # observed examples
        ('[{"key1": [123]', [{"key1": [123]}], JsonFixEnum.UNCLOSED_OBJECT),
        ('{"key1": [\n"abc",\n "def', {"key1": ["abc", "def"]}, JsonFixEnum.UNCLOSED_VALUE),
        ...
        ('[{"key_with_no_value":', [{"key_with_no_value": None}], JsonFixEnum.MISSING_VALUE),
        ('[{"another_key_with_no_value"', [{"another_key_with_no_value": None}], JsonFixEnum.MISSING_VALUE),
        ('{\n"student_model": "The student.",\n "tutor_response": "Good!"', {"student_model": "The student.", "tutor_response": "Good!"}, JsonFixEnum.UNCLOSED_OBJECT),
        ('{\n"text": "Test", "numerical": 123, "reason": true, "sub_element": { "name": "Test" }, "items": ["Item 1", "Item 2 \n\n\n', {"text": "Test", "numerical": 123, "reason": True, "sub_element": { "name": "Test" }, "items": ["Item 1", "Item 2"]}, JsonFixEnum.UNCLOSED_VALUE),
    ]
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('{"status": "success", "data": {"isAdmin": true, "isActive": false}}', False)
        ),
        # Fix "True" to "true"
        (
        '{"status": "success", "data": {"isAdmin": True, "isActive": false}}',
        ('{"status": "success", "data": {"isAdmin": true, "isActive": false}}', True)
        ),
        # Fix "False" to "false"
        (
        '{"status": "success", "data": {"isAdmin": true, "isActive": False}}',
        ...
        ('{"status": "TrueValue", "data": {"isAdmin": true, "isActive": false, "attribute": "FalsePositive"}}', True)
        ),
    ]
)
